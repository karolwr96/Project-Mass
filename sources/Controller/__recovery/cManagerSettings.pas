...
TManagerSettings = class
  ...
  public
    ...
    class function Instance : TManagerSettings; //Instance odpowiada za przydzielanie pamięci do przechowywania nowej instancji klasy
    class procedure ReleaseInstance; //ReleaseInstance jest odpowiedzialne za zwalnianie pamięci, gdy klasa zostanie zniszczona
end;
...
begin
  //Instance odpowiada za przydzielanie pamięci do przechowywania nowej instancji klasy
...
begin
  //ReleaseInstance jest odpowiedzialne za zwalnianie pamięci, gdy klasa zostanie zniszczona
  FInstance.Free;
end;
