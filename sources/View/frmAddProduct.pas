...
//napisane na szybko, w celu testu dodawania do bazy - dane dostêpowe powinno pobieraæ
// z cItemSettings - do przerobienia
...
begin
  ...
  try
    try
      ...
      UniQuery.ExecSQL;
      ShowMessage('Produkt dodano pomyœlnie!');
  Except
      ShowMessage('Coœ posz³o nie tak!');
    end;
  finally
    UniQuery.Free;
    UniConnection.Free;
