...
begin
 if FormAddContractor = nil then
   ...
   // end;
    ...
    //pokazanie wiadomości o dodaniu kontrahenta przeniesione do frmAddContractor
    //ponowne otwarcia okna dodaj kontrahenta gdy dane zostaną dodane do pliku xml ???
end;
